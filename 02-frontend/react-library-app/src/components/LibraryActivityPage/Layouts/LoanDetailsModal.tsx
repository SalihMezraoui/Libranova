                        ...
                        <div className="modal-body px-4">
                            ...
                            {props.userLoanSummary.daysRemaining > 0 && (
                                <p className='text-muted'>
                                    <strong>Days remaining: </strong>{props.userLoanSummary.daysRemaining}
                                </p>
                            )}
                            {props.userLoanSummary.daysRemaining === 0 && (
                            ...
                            {props.userLoanSummary.daysRemaining < 0 && (
                                <p className='text-danger fw-semibold'>
                                    <strong>Overdue by: </strong> {Math.abs(props.userLoanSummary.daysRemaining)} days
                                </p>
                            )}
